        ...
        <div className="border-border/60 space-y-3 border-b px-4 pt-4 pb-3">
          ...
          <div className="flex items-center gap-2">
            <Button
              ...
              className={`flex-1 flex gap-2 justify-center transition-all ${usingGeolocation
                ? 'bg-amber-500 text-white border-amber-500 hover:bg-amber-600 hover:text-white dark:text-amber-950 dark:hover:text-amber-950 shadow-sm'
                : 'bg-muted/40 hover:bg-muted font-medium'
                }`}
            >
              <Navigation className="h-4 w-4" />
              {usingGeolocation ? 'Location Updated' : 'Update Current Location'}
            </Button>
          ...
          <div className="relative w-full">
            ...
            <Input
              ...
              className="bg-muted/40 border-border/60 w-full h-9 pl-9 text-sm focus-visible:ring-amber-400/50"
            />
          </div>
